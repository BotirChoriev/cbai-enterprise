...
export const HOME_MODULES: HomeModule[] = [
  ...
  },
  {
    ...
    evidenceStatus: "Local registry connected — extended blocks require sources",
    currentCapability: "Registry profile, 10 intelligence blocks, persona views, linked records.",
    futureCapability: "Accreditation, research, scholarship, and transparency evidence sources.",
  ...
  },
  {
    ...
    icon: "graph",
    status: "available",
    purpose: "Navigate verified relationships between platform entities.",
    evidenceStatus: "Catalog-derived edges only — no inferred links",
    currentCapability: "Interactive graph with evidence status per relationship.",
    futureCapability: "Government, industry, procurement, and research center nodes.",
