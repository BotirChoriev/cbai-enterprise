...
export const MODULE_ACCOUNTABILITY: readonly ModuleAccountabilityEntry[] = [
  ...
  {
    route: "/problems",
    moduleName: "Problem Space",
    realWork: "Open and investigate a problem through evidence, unknowns, contradictions, scenarios, and human decision checkpoints.",
    evidenceEnters: "Human problem statements, confirmed evidence records, explicit unknowns, contradictions, risks, and monitoring triggers.",
    reasoningHappens: "AI structures and compares the investigation while final decisions remain explicitly human-owned.",
    knowledgeLeaves: "Durable Problem snapshots, append-only decision history, audit events, and review state.",
    whoBenefits: "People and teams making evidence-based decisions with AI assistance.",
    riskExists: "AI must not silently convert assumptions into facts, bypass authorization, or make the final decision.",
    maturity: "live",
  },
  {
    route: "/search",
  ...
  },
  {
    route: "/evidence",
    moduleName: "Evidence",
    realWork: "Inspect official source connection status and create confirmation-gated evidence records.",
    evidenceEnters: "Evidence infrastructure registry and user-confirmed local evidence records.",
    reasoningHappens: "Source readiness assessment and human evidence review — no live fetch, no fabricated reliability.",
    knowledgeLeaves: "Understanding of what is connected vs missing, plus confirmed evidence linked to work.",
  ...
  {
    route: "/knowledge",
    moduleName: "Evidence (legacy alias)",
    realWork: "Legacy alias of the Evidence explorer — canonical route is /evidence.",
    ...
    whoBenefits: "Anyone verifying provenance before deciding.",
    riskExists: "Legacy route alias only — canonical path is /evidence.",
    maturity: "partial",
  },
  {
    route: "/rooms",
    moduleName: "Live Intelligence Rooms",
    realWork: "Run shared live sessions with multilingual transcript and confirmation-gated operational actions.",
    evidenceEnters: "Participant utterances, meeting glossary terms, and linked entity references — locally stored.",
    reasoningHappens: "Deterministic translation routing and proposal drafting — no automated decisions, human confirmation required.",
    knowledgeLeaves: "Meeting transcripts, decisions, and proposed Draft Work Cards awaiting confirmation.",
    whoBenefits: "Teams and multilingual collaborators coordinating intelligence work.",
    riskExists: "Live provider verification is environment-dependent; audio retention is never implied and transcript retention is explicit.",
    maturity: "preview",
  },
  {
    route: "/graph",
