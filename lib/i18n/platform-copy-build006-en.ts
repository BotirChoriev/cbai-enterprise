...
export const SEARCH_EN = {
  ...
  notInRegistry: '"{query}" is not in the current registry.',
  closestMatchesHeading: "Closest registry matches",
  closestMatchNote: "Closest only — not a verified match for this query.",
  createResearchRequest: "Create a research request",
  connectSourceAction: "Connect an official source",
  examplesAreNotResults: "Examples below are sample queries, not results for your search.",
  ...
  matchReasonLabel: "Why it matched",
  registryStatusVerified: "Local registry",
  ...
  opensTo: "Opens to",
  exampleSearchesAria: "Example searches (not live results)",
...
export const EVIDENCE_EN = {
  ...
  graphEdgesVerified: "{verified} verified / {total}",
  entityCoverageTitle: "Available evidence by profile",
  entityCoverageDescription: "Evidence status across countries, companies, and universities.",
  sourceCoverageTitle: "Source coverage",
  sourceCoverageDescription: "Official sources and their connection status.",
  openProfile: "Open",
  profilesAvailableCount: "{count} profiles available",
  noProfilesYet: "No profiles available yet",
  missingInformation: "Missing information",
  missingWhyShort: "What is missing and why.",
  missingWhyLong: "What is missing, why, and which source applies.",
  noMissingRecorded: "No missing information is recorded for this profile.",
  showAllMissing: "Show all {count} missing items",
  noMissingInformation: "No missing information recorded for applicable topics.",
  tableSource: "Source",
  tableOrganization: "Organization",
  tableCoverage: "Coverage",
  tableRelatedItems: "Related items",
  tableSourceStatus: "Source status",
...
export const SETTINGS_EN = {
  ...
  voiceDiagnosticsHeading: "Voice diagnostics",
  voiceDiagnosticsNote: "Non-secret capability states only — never shows API keys or session secrets.",
  voiceMicAvailable: "Microphone available",
  voiceMicUnavailable: "Microphone unavailable",
  voiceMicUnknown: "Microphone permission not checked",
  voiceWebrtcSupported: "WebRTC supported",
  voiceWebrtcUnsupported: "WebRTC not supported in this browser",
  voiceBrokerConfigured: "Local voice broker configured",
  voiceBrokerNotConfigured: "Local voice broker not configured",
  voiceBrokerReachable: "Broker reachable",
  voiceBrokerUnreachable: "Broker unreachable",
  voiceBrokerUnknown: "Broker reachability unknown",
  voiceCredentialReceived: "Session credential received",
  voiceCredentialPending: "Session credential pending",
  voiceCredentialUnknown: "Session credential not checked",
  voiceAudioReady: "Remote audio ready",
  voiceAudioPending: "Remote audio pending",
  voiceAudioUnknown: "Remote audio not checked",
  voiceConnectionState: "Connection state",
  voiceRunPreflight: "Run diagnostics",
} as const;
...
export const REASONING_EN = {
  ...
  informationConnected: "Information connected",
  sourcesConnected: "Sources connected",
  relatedInformationHeading: "Related information",
  relatedInformationLead: "Topic areas, evidence needs, and current source status.",
  tableDomain: "Domain",
  tableTopics: "Topics",
  tableConnected: "Connected",
  tableEvidenceNeeds: "Evidence needs",
  tableStatus: "Status",
} as const;
