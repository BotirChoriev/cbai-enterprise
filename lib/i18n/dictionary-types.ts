...
export type TranslationDictionary = {
  ...
  accountPage: {
    ...
    passwordChangeUnavailable: string;
    sessionHeading: string;
    sessionEmail: string;
    sessionRestoring: string;
    sessionRestored: string;
    sessionNoMultiDeviceRevoke: string;
    ...
    cloudGateTitle: string;
    cloudGateHeading: string;
    cloudGateBody: string;
    cloudGateLocalOnly: string;
    cloudGateRestoring: string;
    cloudGateCta: string;
  };
  reportsCenter: {
