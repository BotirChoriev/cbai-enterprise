...
export const ENTITY_INTELLIGENCE_UZ = {
  ...
  missingWhyShort: "Nima yetishmayapti va nima uchun.",
  missingWhyLong:
    "Quyidagilar ushbu profil uchun qayd etilgan ma'lumot bo'shliqlari. Rasmiy manba nomlari asl tilda qoladi.",
  noMissingRecorded: "Ushbu profil uchun hali yetishmayotgan ma'lumot bo'shliqlari qayd etilmagan.",
  showAllMissing: "Barcha {count} yetishmayotgan bandni ko'rsatish",
  gapWhyMissing: "Nega yetishmayapti",
  gapExpectedSource: "Kutilayotgan manba",
  gapNextStep: "Keyingi qadam",
  gapStatusAvailable: "Hozir mavjud",
  gapStatusPlanned: "Hali mavjud emas",
  gapStatusMissing: "Yetishmayapti",
  gapStatusBlocked: "Mavjud emas",
  gapReasonNotConnected: "Rasmiy manba bu profilda hali mavjud emas.",
  gapReasonConnectorPlanned: "Rasmiy manba rejalashtirilgan, ammo hali mavjud emas.",
  gapReasonNotMapped: "Bu mavzuga hali rasmiy manba bog'lanmagan.",
  gapReasonMethodologyPending: "Bu mavzu uchun tekshiruv usuli hali yakunlanmagan.",
  gapReasonSourceUnavailable: "Rasmiy manba endi mavjud emas.",
  gapReasonVerificationPending: "Rasmiy manba ko'rsatilishidan oldin tekshiruvni kutmoqda.",
  gapReasonDefault: "Bu mavzu bo'yicha rasmiy ma'lumot hali mavjud emas.",
  gapNextAvailable: "Qarorda ishlatishdan oldin bu ma'lumotni ko'rib chiqing.",
  gapNextPlanned: "{source} bu profilda mavjud bo'lganda qayta tekshiring.",
  gapNextPlannedNoSource: "Rasmiy manba bu profilda mavjud bo'lganda qayta tekshiring.",
  gapNextBlocked: "Bu mavzuni hozirgi rasmiy manbalardan to'ldirib bo'lmaydi.",
  gapNextMissing: "{source} rasmiy ma'lumoti hali ulanmagan.",
  gapNextMissingNoSource: "Bu mavzu bo'yicha rasmiy ma'lumot hali ulanmagan.",
  gapSummaryTotalTopics: "Jami tegishli mavzular",
  gapSummaryTransparencyPolicy: "Shaffoflik siyosati",
  gapSummaryCountsOnly: "Faqat sonlar — soxta foizlar yoki bashoratlar yo'q",
  gapSummaryHumanReview: "Inson tekshiruvi talab qilinadi",
  gapSummaryHumanReviewBody:
    "Bo'shliq ma'lumoti faqat ulanish holatini tavsiflaydi — davlat kamchiligi, yashirilgan ma'lumot yoki tavsiya emas. Qarorda ishlatishdan oldin inson nazorati majburiy.",
  gapSourcesHeading: "Rasmiy manba qamrovi",
  gapSourcesDescription: "Tegishli indikatorlar uchun kutilayotgan rasmiy manbalar va ulagichlar.",
  gapConnectorLabel: "Ulagich: {connector}",
  gapMethodologyHeading: "Metodologiya manbalari",
  gapMethodologyDescription:
    "Bo'shliqlari bor indikatorlar uchun talab qilinadigan dalil va metodologiya — avval tushuntirish, keyin baholash.",
  gapMethodologyLabel: "Metodologiya",
  gapRequiredEvidenceLabel: "Talab qilinadigan dalil",
