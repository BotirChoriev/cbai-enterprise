...
export const ENTITY_INTELLIGENCE_TR = {
  ...
  missingWhyShort: "Eksik olan nedir ve neden.",
  missingWhyLong:
    "Aşağıdakiler bu profil için kaydedilmiş bilgi boşluklarıdır. Resmi kaynak adları orijinal dilinde kalır.",
  noMissingRecorded: "Bu profil için henüz eksik bilgi boşluğu kaydedilmedi.",
  showAllMissing: "Tüm {count} eksik öğeyi göster",
  gapWhyMissing: "Neden eksik",
  gapExpectedSource: "Beklenen kaynak",
  gapNextStep: "Sonraki adım",
  gapStatusAvailable: "Şu anda mevcut",
  gapStatusPlanned: "Henüz mevcut değil",
  gapStatusMissing: "Eksik",
  gapStatusBlocked: "Kullanılamıyor",
  gapReasonNotConnected: "Resmî kaynak bu profilde henüz mevcut değil.",
  gapReasonConnectorPlanned: "Resmî kaynak planlandı ancak henüz mevcut değil.",
  gapReasonNotMapped: "Bu konuya henüz resmî bir kaynak bağlanmadı.",
  gapReasonMethodologyPending: "Bu konunun inceleme yöntemi henüz tamamlanmadı.",
  gapReasonSourceUnavailable: "Resmî kaynak artık mevcut değil.",
  gapReasonVerificationPending: "Resmî kaynak gösterilmeden önce incelemeyi bekliyor.",
  gapReasonDefault: "Bu konuyla ilgili resmî bilgi henüz mevcut değil.",
  gapNextAvailable: "Bir kararda kullanmadan önce bu bilgiyi gözden geçirin.",
  gapNextPlanned: "{source} bu profilde mevcut olduğunda tekrar kontrol edin.",
  gapNextPlannedNoSource: "Resmî kaynak bu profilde mevcut olduğunda tekrar kontrol edin.",
  gapNextBlocked: "Bu konu mevcut resmî kaynaklardan doldurulamaz.",
  gapNextMissing: "{source} kaynağından resmî bilgi henüz bağlanmadı.",
  gapNextMissingNoSource: "Bu konuyla ilgili resmî bilgi henüz bağlanmadı.",
  gapSummaryTotalTopics: "Toplam geçerli konu",
  gapSummaryTransparencyPolicy: "Şeffaflık politikası",
  gapSummaryCountsOnly: "Yalnızca sayılar — sahte yüzde veya tahmin yok",
  gapSummaryHumanReview: "İnsan incelemesi gerekli",
  gapSummaryHumanReviewBody:
    "Boşluk bilgisi yalnızca bağlantı durumunu tanımlar — devlet başarısızlığı, gizli veri veya öneri değildir. Karar kullanımından önce insan denetimi zorunludur.",
  gapSourcesHeading: "Resmî kaynak kapsamı",
  gapSourcesDescription: "Geçerli göstergeler için beklenen resmî kaynaklar ve bağlayıcılar.",
  gapConnectorLabel: "Bağlayıcı: {connector}",
  gapMethodologyHeading: "Metodoloji referansları",
  gapMethodologyDescription:
    "Boşluğu olan göstergeler için gereken kanıt ve metodoloji — önce açıklama, sonra değerlendirme.",
  gapMethodologyLabel: "Metodoloji",
  gapRequiredEvidenceLabel: "Gerekli kanıt",
