...
export const SEARCH_TR = {
  ...
  notInRegistry: '"{query}" geçerli kayıtta yok.',
  closestMatchesHeading: "En yakın kayıt eşleşmeleri",
  closestMatchNote: "Yalnızca yakınlık — bu sorgu için doğrulanmış eşleşme değil.",
  createResearchRequest: "Araştırma talebi oluştur",
  connectSourceAction: "Resmi kaynak bağla",
  examplesAreNotResults: "Aşağıdaki örnekler örnek sorgulardır; aramanızın sonuçları değildir.",
  ...
  matchReasonLabel: "Neden eşleşti",
  registryStatusVerified: "Yerel kayıt",
  ...
  opensTo: "Açar",
  exampleSearchesAria: "Örnek aramalar (canlı sonuç değil)",
...
export const EVIDENCE_TR = {
  ...
  missingWhyLong: "Eksik olan nedir, neden ve hangi kaynak geçerlidir.",
  noMissingRecorded: "Bu profil için kaydedilmiş eksik bilgi yok.",
  showAllMissing: "Eksik {count} öğenin tümünü göster",
