...
export const SEARCH_UZ = {
  ...
  notInRegistry: '"{query}" joriy reyestrda yo‘q.',
  closestMatchesHeading: "Eng yaqin reyestr yozuvlari",
  closestMatchNote: "Faqat yaqinlik — ushbu so‘rov uchun tasdiqlangan moslik emas.",
  createResearchRequest: "Tadqiqot so‘rovini yaratish",
  connectSourceAction: "Rasmiy manbani ulash",
  examplesAreNotResults: "Quyidagi misollar namuna so‘rovlar — qidiruv natijasi emas.",
  ...
  matchReasonLabel: "Nima uchun mos keldi",
  registryStatusVerified: "Mahalliy reyestr",
  ...
  opensTo: "Ochiladi",
  exampleSearchesAria: "Misol qidiruvlar (jonli natija emas)",
...
export const EVIDENCE_UZ = {
  ...
  graphEdges: "Graf bog‘lamalari",
  graphEdgesVerified: "{verified} tasdiqlangan / {total}",
  entityCoverageTitle: "Profil bo‘yicha mavjud dalillar",
  entityCoverageDescription: "Mamlakatlar, kompaniyalar va universitetlar bo‘yicha dalil holati.",
  sourceCoverageTitle: "Manba qamrovi",
  sourceCoverageDescription: "Rasmiy manbalar va ularning bog‘lanish holati.",
  openProfile: "Ochish",
  profilesAvailableCount: "{count} profil mavjud",
  noProfilesYet: "Hozircha profillar mavjud emas",
  missingInformation: "Yetishmayotgan ma’lumot",
  missingWhyShort: "Nima yetishmayapti va nima uchun.",
  missingWhyLong: "Nima yetishmayapti, nima uchun va qaysi manba tegishli.",
  noMissingRecorded: "Bu profil uchun yetishmayotgan ma’lumot qayd etilmagan.",
  showAllMissing: "Barcha {count} ta yetishmayotgan bandni ko‘rsatish",
  noMissingInformation: "Mavzu bo‘yicha yetishmayotgan ma’lumot qayd etilmagan.",
  tableSource: "Manba",
  tableOrganization: "Tashkilot",
  tableCoverage: "Qamrov",
  tableRelatedItems: "Bog‘liq elementlar",
  tableSourceStatus: "Manba holati",
  tableVerification: "Tasdiqlash",
  tableUpdate: "Yangilanish",
  tableLicense: "Litsenziya",
...
export const SETTINGS_UZ = {
  ...
  themeLight: "Yorug‘",
  themeDeep: "Chuqur",
  themeAriaLabel: "Interfeys mavzusi",
  ...
  voiceDiagnosticsHeading: "Ovoz diagnostikasi",
  voiceDiagnosticsNote: "Faqat maxfiy bo‘lmagan holatlar — API kalitlari yoki sessiya sirlarini ko‘rsatmaydi.",
  voiceMicAvailable: "Mikrofon mavjud",
  voiceMicUnavailable: "Mikrofon mavjud emas",
  voiceMicUnknown: "Mikrofon ruxsati tekshirilmagan",
  voiceWebrtcSupported: "WebRTC qo‘llab-quvvatlanadi",
  voiceWebrtcUnsupported: "Ushbu brauzerda WebRTC qo‘llab-quvvatlanmaydi",
  voiceBrokerConfigured: "Mahalliy ovoz brokeri sozlangan",
  voiceBrokerNotConfigured: "Mahalliy ovoz brokeri sozlanmagan",
  voiceBrokerReachable: "Brokerga ulanish mumkin",
  voiceBrokerUnreachable: "Brokerga ulanib bo‘lmadi",
  voiceBrokerUnknown: "Broker ulanishi noma’lum",
  voiceCredentialReceived: "Sessiya credentiali olindi",
  voiceCredentialPending: "Sessiya credentiali kutilmoqda",
  voiceCredentialUnknown: "Sessiya credentiali tekshirilmagan",
  voiceAudioReady: "Masofaviy audio tayyor",
  voiceAudioPending: "Masofaviy audio kutilmoqda",
  voiceAudioUnknown: "Masofaviy audio tekshirilmagan",
  voiceConnectionState: "Ulanish holati",
  voiceRunPreflight: "Diagnostikani ishga tushirish",
} as const;
...
export const REASONING_UZ = {
  ...
  relatedInformationHeading: "Bog'liq ma'lumot",
  relatedInformationLead: "Mavzu sohalari, dalil ehtiyojlari va joriy manba holati.",
  tableDomain: "Soha",
  tableTopics: "Mavzular",
  tableConnected: "Ulangan",
  tableEvidenceNeeds: "Dalil ehtiyojlari",
  tableStatus: "Holat",
} as const;
