...
const tr: TranslationDictionary = {
  ...
  navigation: {
    ...
    worldIntelligence: "Dünya İstihbaratı",
    researchEvidence: "Araştırma ve Kanıt",
    specialistWorkspaces: "Uzman çalışma alanları",
    globalActivity: "Küresel etkinlik",
    discover: "Keşfet",
    create: "Oluştur",
    privacy: "Gizlilik",
    globalUpdates: "Küresel güncellemeler",
  },
  home: {
