...
const uz: TranslationDictionary = {
  ...
  navigation: {
    ...
    worldIntelligence: "Jahon tahlili",
    researchEvidence: "Tadqiqot va dalillar",
    specialistWorkspaces: "Maxsus ish maydonlari",
    globalActivity: "Global faoliyat",
    discover: "Kashf etish",
    create: "Yaratish",
    privacy: "Maxfiylik",
    globalUpdates: "Global yangilanishlar",
  },
  home: {
