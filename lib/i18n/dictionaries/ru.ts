...
const ru: TranslationDictionary = {
  ...
  navigation: {
    ...
    worldIntelligence: "Мировая аналитика",
    researchEvidence: "Исследования и доказательства",
    specialistWorkspaces: "Специализированные пространства",
    globalActivity: "Глобальная активность",
    discover: "Обзор",
    create: "Создание",
    privacy: "Конфиденциальность",
    globalUpdates: "Глобальные обновления",
  },
  home: {
  ...
  organizationOs: { ...ORGANIZATION_OS_RU, ...ORG_WORKSPACE_RU, ...SHARED_BACKEND_RU },
