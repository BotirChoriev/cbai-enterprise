...
export const ENTITY_INTELLIGENCE_EN = {
  ...
  missingWhyLong:
    "Each item below is a known information gap for this profile. Official source titles stay in their original language.",
  noMissingRecorded: "No missing-information gaps are recorded for this profile yet.",
  showAllMissing: "Show all {count} missing items",
  gapWhyMissing: "Why missing",
  gapExpectedSource: "Expected source",
  gapNextStep: "Next step",
  gapStatusAvailable: "Available now",
  gapStatusPlanned: "Not yet available",
  gapStatusMissing: "Missing",
  gapStatusBlocked: "Unavailable",
  gapReasonNotConnected: "The official source is not available on this profile yet.",
  gapReasonConnectorPlanned: "The official source is planned but not available yet.",
  gapReasonNotMapped: "No official source is linked to this topic yet.",
  gapReasonMethodologyPending: "The review method for this topic is not finalized yet.",
  gapReasonSourceUnavailable: "The official source is no longer available.",
  gapReasonVerificationPending: "The official source is awaiting review before it can be shown.",
  gapReasonDefault: "Official information for this topic is not available yet.",
  gapNextAvailable: "Review this information before you use it in a decision.",
  gapNextPlanned: "Check back when {source} is available on this profile.",
  gapNextPlannedNoSource: "Check back when the official source is available on this profile.",
  gapNextBlocked: "This topic cannot be filled from current official sources.",
  gapNextMissing: "Official information from {source} is not connected yet.",
  gapNextMissingNoSource: "Official information for this topic is not connected yet.",
  gapSummaryTotalTopics: "Total applicable topics",
  gapSummaryTransparencyPolicy: "Transparency policy",
  gapSummaryCountsOnly: "Counts only — no fake percentages or predictions",
  gapSummaryHumanReview: "Human review required",
  gapSummaryHumanReviewBody:
    "Gap information describes connection posture only — not government failure, hidden data, or recommendations. Human oversight is mandatory before decision use.",
  gapSourcesHeading: "Official Source Coverage",
  gapSourcesDescription: "Expected official sources and connectors referenced by applicable indicators.",
  gapConnectorLabel: "Connector: {connector}",
  gapMethodologyHeading: "Methodology References",
  gapMethodologyDescription:
    "Required evidence and methodology for indicators with gaps — explain before evaluate.",
  gapMethodologyLabel: "Methodology",
  gapRequiredEvidenceLabel: "Required evidence",
