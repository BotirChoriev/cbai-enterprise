# EPIC-13 — Adaptive Intelligence Interface
...
Intelligence Canvas, adaptation by mission and capability, no profession portals.
...
**In scope:** components/canvas/, adaptive-intelligence.ts, IntelligenceCanvas
...
Mobile context layer limited. BUILD-011 orphan components not yet removed.
