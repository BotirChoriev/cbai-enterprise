# EPIC-01 — Universal Intelligence Foundation
...
Supreme Constitution, mission model, Capability Passport foundation, adaptive intelligence, module accountability, operating principles.
...
**In scope:** lib/constitution/, lib/intelligence-os/module-accountability.ts, lib/design/cbai-interface-principles.ts, components/governance-control/
...
Governance lib is declarative only — not runtime-enforced. Three parallel mission vocabularies remain.
