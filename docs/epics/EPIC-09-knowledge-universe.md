...
Mission-aware graph, real nodes, explainable connections, contradictions, missing knowledge.
...
**In scope:** components/graph/, lib/network/
...
Graph from local adapters. Mission instrument partial. No live relationship API.
