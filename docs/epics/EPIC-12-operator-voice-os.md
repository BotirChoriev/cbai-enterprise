...
Persistent Operator, mission awareness, voice permission, transcript, text fallback.
...
**In scope:** lib/assistant/, components/assistant/, operator-awareness.ts
...
Voice depends on browser APIs. No cloud Operator sync. lib/intelligence/ agent runtime is separate alpha.
