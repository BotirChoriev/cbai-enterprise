# EPIC-11 — Civilization Memory & Legacy
...
Reusable project knowledge, evidence chains, failed approaches, long-term preservation.
...
**In scope:** lib/intelligence-os/legacy-trail.ts, LegacyTrail.tsx
...
Device-local artifacts only. No archival or cloud preservation architecture yet.
