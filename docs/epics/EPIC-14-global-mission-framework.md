# EPIC-14 — Global Mission Framework
...
Humanity-scale challenges, transparent participation, real evidence and ownership.
...
**In scope:** lib/missions/ (declarative catalog only), /government /investor /citizen previews
...
Persona workspaces are preview lenses — not live global missions.
