# EPIC-10 — Humanity Impact & Responsible Progress
...
Intended benefit, harm, environment, ethics, report readiness rules, qualitative states.
...
**In scope:** lib/intelligence-os/human-impact-*, HumanImpactPanel, report-readiness.ts
...
Qualitative only — no fake scores. Export formats honestly unavailable.
