# EPIC-04 — Discovery & Opportunity Network
...
Emerging capability discovery, matching, explanations, privacy and bias audit architecture.
...
**In scope:** lib/discovery/discovery-engine.ts
...
Honestly not connected externally. No real matching. Documentation and safety rules only.
