# EPIC-07 — Research & Reasoning Operating System
...
Research questions, methodology, reasoning structure, peer review framing, publication readiness.
...
**In scope:** components/research/, lib/research-mission/, /reasoning
...
Live scientific databases not connected. Reasoning module is methodology framing, not automated inference.
