...
Evidence ingestion, provenance, verification, conflicting/outdated evidence, audit trail.
...
**In scope:** lib/evidence/, lib/foundation/, components/evidence*, /trust, /knowledge
...
Live API ingestion not connected. Source status is declared, not fetched.
