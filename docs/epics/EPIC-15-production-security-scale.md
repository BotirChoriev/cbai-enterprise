# EPIC-15 — Production, Security & Scale
...
Auth, cloud sync, privacy, audit, Cloudflare, Supabase readiness, release gates.
...
**In scope:** lib/auth/, lib/cloud/, supabase/, test-cloud-platform.ts
...
Supabase optional. Cloud sync partial. No production incident runbook in repo.
