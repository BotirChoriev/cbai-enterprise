# EPIC-08 — Universal Knowledge & Entity System
...
Countries, companies, universities, relationships, shared entity grammar.
...
**In scope:** lib/foundation/adapters/, components/countries|companies|universities/, lib/entity*
...
Local catalogs only. Extended entity types prepared but not all connected.
