# EPIC-03 — Intelligence Identity & Capability Passport
...
Demonstrated capability model, provenance, user visibility, no IQ, no global ranking.
...
**In scope:** lib/capability/, components/capability/CapabilityPassportPanel.tsx
...
No credential verification flow. No user challenge/correct UI. Not used for access control.
