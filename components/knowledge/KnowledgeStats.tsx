...
import { getKnowledgeStats, knowledgeCollections } from "@/lib/knowledge";

const stats = getKnowledgeStats(knowledgeCollections);
  ...
  return (
    <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
      ...
      <StatCard
        ...
        value={stats.indexedSources}
        change={`${knowledgeCollections.length - stats.indexedSources} pending or syncing`}
        changeType="neutral"
        icon={
          <svg
            className="h-4 w-4"
      ...
      <StatCard
        ...
        value={`${stats.searchAccuracy}%`}
        change="RAG retrieval confidence"
        changeType="positive"
        icon={
          <svg
            className="h-4 w-4"
