...
export default function CountryIndicatorCoverage({
  ...
  return (
    <section className="space-y-4" aria-labelledby="country-indicator-coverage-heading">
      <div>
        <h3
          id="country-indicator-coverage-heading"
          className="text-sm font-semibold uppercase tracking-wider text-zinc-500"
        >
          Indicator Coverage
        </h3>
        <p className="mt-1 text-sm text-zinc-500">
          Global Indicator Framework — applicable country indicators grouped by domain.
        </p>
      </div>
