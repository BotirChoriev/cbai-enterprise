import type { CountryEvidenceCoverageSummary } from "@/lib/countries.coverage";
import { coverageStatusClass } from "@/lib/countries.coverage";

type CountryCoveragePanelProps = {
  summary: CountryEvidenceCoverageSummary;
...
export default function CountryCoveragePanel({
  ...
  return (
    <section className="space-y-4" aria-labelledby="country-evidence-coverage-heading">
      <div>
        <h3
          id="country-evidence-coverage-heading"
