...
import { formatRelationshipAvailability } from "@/lib/countries.adapter";
import { NOT_AVAILABLE_SOURCE_LABEL } from "@/lib/countries.intelligence";
      ...
      <div className="rounded-xl border border-zinc-800 bg-zinc-950">
        <div className="border-b border-zinc-800 px-6 py-4">
          <h3 className="text-sm font-semibold text-zinc-50">
            Linked Local Registries
          </h3>
          <p className="text-xs text-zinc-500">
            Relationships derived from local company and university catalogs only
          </p>
        </div>
        ...
        <div className="grid gap-px bg-zinc-800 sm:grid-cols-2">
          {sections.map((section) => {
            ...
            const unavailable = section.key === "industries";
