...
export default function LandscapeCenter({ centerTopic, compact = false }: LandscapeCenterProps) {
  return (
    <div className="relative flex flex-col items-center">
      <div
        className="pointer-events-none absolute inset-0 -z-10 rounded-full bg-teal-500/10 blur-3xl"
        aria-hidden="true"
      />
      <div
      ...
      >
        ...
        <p className="mt-1 text-xs text-teal-300/80">{centerTopic.domain}</p>
        {!compact ? (
