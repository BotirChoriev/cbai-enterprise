...
const actionLink = `${cbaiGlassCard} flex flex-col px-5 py-4 transition-colors hover:border-cyan-500/25`;
    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <Link href="/knowledge" className={actionLink}>
          <span className="text-sm font-semibold text-cyan-400">Evidence</span>
          <span className="mt-1 text-xs text-zinc-500">
