...
/**
 * Evidence detail per official source — the same full field set Country/Company got (Publisher,
 * Publication date, Confidence, Citation, Open source link). Publication date, citation, and
 * confidence do not exist as real data anywhere in this platform today — shown honestly as
 * "Not assessed"/"Not available" rather than invented.
 */
export default function UniversitySourceCoverage({ sources }: UniversitySourceCoverageProps) {
  return (
    <section className="space-y-4" aria-labelledby="university-source-coverage-heading">
      <div>
        <h3
          id="university-source-coverage-heading"
          className="text-sm font-semibold uppercase tracking-wider text-zinc-500"
        >
          Official Source Coverage
        </h3>
        <p className="mt-1 text-sm text-zinc-500">
          Official evidence sources for university intelligence — connection status only, no
